...
function check1()
{
    if(document.getElementById("qOne1").checked)
        {
            document.getElementById("divOne2").style.backgroundColor = "blue";
        ...
        {
            document.getElementById("divOne2").style.backgroundColor = "blue";
            document.getElementById("divOne3").style.backgroundColor = "red";
            document.getElementById("message1").textContent = "Incorrect";
        }
...
function check2()
{
    if(document.getElementById("qTwo4").checked)
        {
            document.getElementById("divTwo1").style.backgroundColor = "blue";
            document.getElementById("divTwo4").style.backgroundColor = "red";
    ...
    else if(document.getElementById("qTwo1").checked)
        {
            document.getElementById("divTwo1").style.backgroundColor = "blue";
...
function check3()
{
    if(document.getElementById("qThree1").checked)
        {
            document.getElementById("divThree4").style.backgroundColor = "blue";
        ...
        {
            document.getElementById("divThree4").style.backgroundColor = "blue";
            document.getElementById("divThree2").style.backgroundColor = "red";
            document.getElementById("message3").textContent = "Incorrect";
        }
...
function check4()
{
    if(document.getElementById("qFour3").checked)
        {
            document.getElementById("divFour1").style.backgroundColor = "blue";
            document.getElementById("divFour3").style.backgroundColor = "red";
            document.getElementById("message4").textContent = "Incorrect";
        }
    else if(document.getElementById("qFour1").checked)
        {
            document.getElementById("divFour1").style.backgroundColor = "blue";
...
function check5()
{
    if(document.getElementById("qFive1").checked)
        {
            document.getElementById("divFive3").style.backgroundColor = "blue";
        ...
        {
            document.getElementById("divFive3").style.backgroundColor = "blue";
            document.getElementById("divFive2").style.backgroundColor = "red";
            document.getElementById("message5").textContent = "Incorrect";
        }
...
function check6()
{
    if(document.getElementById("qSix3").checked)
        {
            document.getElementById("divSix3").style.backgroundColor = "blue";
            document.getElementById("message6").textContent = "Correct";
            score++;
        }
    else if(document.getElementById("qSix2").checked)
        {
            document.getElementById("divSix3").style.backgroundColor = "blue";
            document.getElementById("divSix2").style.backgroundColor = "red";
...
function check8()
{
    if(document.getElementById("qEight2").checked)
        {
            document.getElementById("divEight1").style.backgroundColor = "blue";
            document.getElementById("divEight2").style.backgroundColor = "red";
            document.getElementById("message8").textContent = "Incorrect";
        }
    else if(document.getElementById("qEight1").checked)
        {
            document.getElementById("divEight1").style.backgroundColor = "blue";
...
function check9()
{
    if(document.getElementById("qNine4").checked)
        {
            document.getElementById("divNine1").style.backgroundColor = "blue";
        ...
        {
            document.getElementById("divNine1").style.backgroundColor = "blue";
            document.getElementById("divNine3").style.backgroundColor = "red";
            document.getElementById("message9").textContent = "Incorrect";
        }
    else if(document.getElementById("qNine1").checked)
        {
            document.getElementById("divNine1").style.backgroundColor = "blue";
...
function check10()
{
    if(document.getElementById("qTen1").checked)
        {
            document.getElementById("divTen4").style.backgroundColor = "blue";
            document.getElementById("divTen1").style.backgroundColor = "red";
    ...
    else if(document.getElementById("qTen3").checked)
        {
            document.getElementById("divTen4").style.backgroundColor = "blue";
